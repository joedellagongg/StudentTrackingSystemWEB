...
export default function Announcement() {
  ...
  return (
    <main className=" relative first-line:w-full h-full rounded-2xl overflow-x-scroll bg-white grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-6 gap-3">
      {loading ? (
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="w-[50%] h-[50%] bg-white rounded-xl flex flex-col justify-center items-center p-6">
            ...
            <div className="w-full h-[20%] flex flex-row justify-end items-center px-6 gap-x-2">
              ...
              <button className="bg-red-500 rounded-xl p-4 text-white">
                Delete
              </button>
            </div>
          </div>
