        ...
        <div className="overflow-y-scroll h-[90%] w-full flex flex-col gap-y-3 items-center">
          <div className=" grid grid-cols-3 justify-around w-full gap-6">
            <div className=" flex flex-col justify-center">
              ...
              <input
                ...
                onChange={(e) =>
                  setStudentData({ ...studentData, fname: e.target.value })
                }
            ...
            <div className=" flex flex-col justify-center">
              ...
              <input
                ...
                onChange={(e) =>
                  setStudentData({ ...studentData, lname: e.target.value })
                }
                className="border rounded-xl h-10 p-3 bg-[#E5F1FF]"
              />
            </div>
            <div className=" flex flex-col justify-center">
              ...
              <input
                ...
                onChange={(e) =>
                  setStudentData({ ...studentData, mname: e.target.value })
                }
                className="border rounded-xl h-10 p-3 bg-[#E5F1FF]"
              />
            </div>
          ...
          <div className=" flex flex-col justify-center">
            ...
            <input
              ...
              onChange={(e) =>
                setStudentData({ ...studentData, studcontact: e.target.value })
              }
              className="border rounded-xl h-10 p-3 bg-[#E5F1FF]"
            />
          </div>
          ...
          <div className=" flex flex-col justify-center">
            ...
            <input
              ...
              onChange={(e) =>
                setStudentData({ ...studentData, mother: e.target.value })
              }
              className="border rounded-xl h-10 p-3 bg-[#E5F1FF]"
            />
          </div>
          ...
          <div className=" flex flex-col justify-center">
            ...
            <input
              ...
              onChange={(e) =>
                setStudentData({ ...studentData, father: e.target.value })
              }
              className="border rounded-xl h-10 p-3 bg-[#E5F1FF]"
            />
          </div>
          ...
          <div className=" flex flex-col justify-center">
            ...
            <input
              ...
              onChange={(e) =>
                setStudentData({ ...studentData, guardian: e.target.value })
              }
              className="border rounded-xl h-10 p-3 bg-[#E5F1FF]"
            />
          </div>
